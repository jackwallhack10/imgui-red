...
local library library = {
    new = function(options)
        ...
        options = settings.new({
            text = "New Window",
            size = Vector2.new(477, 409),
            shadow = 10,
            transparency = 0.2,
            color = Color3.fromRGB(155, 3, 3),
            boardcolor = Color3.fromRGB(21, 22, 23),
            rounding = 5,
            animation = 0.1,
            position = UDim2.new(0, 627, 0, 257),
        }).handle(options)
            ...
            local types = { } do
                ...
                function types.color(colorOptions)
                    ...
                    function colorCache.update_layers(y)
                        colorPicker:FindFirstChild("Shadow").Visible = false
                ...
                function types.dropdown(dropdownOptions)
                    ...
                    dropdownOptions = settings.new({
                        ...
                        color = options.color,
                        rounding = options.rounding,
                        selectioncolor = bleach(options.color),
                    ...
                    function dropdownCache.update_layers(y)
                        dropdownWindow:FindFirstChild("Shadow").Visible = false
